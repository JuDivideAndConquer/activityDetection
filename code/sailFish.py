...
def initialise(population,partCount, dim, trainX, testX, trainy, testy):    
...
def sailFish(dataset,population,pop_size,dimension):
        ...
        pop=init(s_size,dimension)
        sf_pop = initialise(population,pop_size, dimension, trainX, testX, trainy, testy) 
        s_pop = initialise(pop,s_size, dimension, trainX, testX, trainy, testy) 
